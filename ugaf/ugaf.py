...
class UGAF:
	...
	def __init__(self, config):
		...
		if "tqdm_disable" in self.config:
			self.tqdm_disable = self.config["tqdm_disable"]
	...
	def sample_graphs(self):
		...
		for i in tqdm(range(self.config["ensemble_size"]), desc="Sampling Embeddings:", disable=self.tqdm_disable):
	...
	def build_similarity_matrix(self):
		...
		"""
		# g1 sims
		for i in tqdm(range(len(self.emb_samps["g1"])), desc="Similarity Measure g1vg1", disable=self.tqdm_disable):
		...
		# g2 sims
		for i in tqdm(range(len(self.emb_samps["g2"])-1), desc="Similarity Measure g2vg2", disable=self.tqdm_disable):
		...
		# g1 v g2 sims
		for i in tqdm(range(len(self.emb_samps["g1"])), desc="Similarity Measure g1vg2", disable=self.tqdm_disable):
	...
	def compute_wasserstein_distance(self):
		...
		# G1vG1 Measure
		was_dist_g1vg1 = []
		for i in tqdm(range(len(self.sim_matrices["g1vg1"])), desc="Measuring Wasserstein Distance g1vg1", disable=self.tqdm_disable):
		...
		# G2vG2 Measure
		was_dist_g2vg2 = []
		for i in tqdm(range(len(self.sim_matrices["g2vg2"])-1), desc="Measuring Wasserstein Distance g2vg2", disable=self.tqdm_disable):
		...
		# G1vG2 Measure
		was_dist_g1vg2 = []
		for i in tqdm(range(len(self.sim_matrices["g1vg2"])-1), desc="Measuring Wasserstein Distance g1vg2", disable=self.tqdm_disable):
	...
	def compute_similatity_matrix_eigen_values(self):
		...
		eigen_g1vg1 = []
		for i in tqdm(range(len(self.sim_matrices["g1vg1"])), desc="Eigen values of g1vg1", disable=self.tqdm_disable):
		...
		eigen_g2vg2 = []
		for i in tqdm(range(len(self.sim_matrices["g2vg2"])), desc="Eigen values of g2vg2", disable=self.tqdm_disable):
		...
		eigen_g1vg2 = []
		for i in tqdm(range(len(self.sim_matrices["g1vg2"])), desc="Eigen values of g1vg2", disable=self.tqdm_disable):
	...
	def compute_similarity_matrix_distribution_properties(self):
		...
		# Run stats g1vg1
		for mtx in tqdm(self.sim_matrices["g1vg1"], desc="Computing sim-matrix properties g1vg1:", disable=self.tqdm_disable):
		...
		# Run stats g2vg2
		for mtx in tqdm(self.sim_matrices["g2vg2"], desc="Computing sim-matrix properties g2vg2:", disable=self.tqdm_disable):
			mtx_flat = mtx.flatten()
		...
		# Run stats g1vg2
		for mtx in tqdm(self.sim_matrices["g1vg2"], desc="Computing sim-matrix properties g1vg2:", disable=self.tqdm_disable):
			mtx_flat = mtx.flatten()
